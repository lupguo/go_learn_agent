...
// Agent is the s17 lead agent with autonomous teammate support.
type Agent struct {
...
func New(provider llm.Provider, registry *tool.Registry, bus *MessageBus) *Agent {
	...
	return &Agent{
		...
		registry:  registry,
		bus:       bus,
		system:    fmt.Sprintf("You are a team lead at %s. Teammates are autonomous -- they find work themselves.", cwd),
		maxTokens: 8000,
	}
}
